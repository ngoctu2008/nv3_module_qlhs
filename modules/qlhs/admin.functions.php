...
if(defined('NV_IS_GODADMIN')){
	$allow_func = array( 'main', 'groups', 'quanly', 'quanly_nam', 'test', 'addnam','delnam','quanly_mon', 'addmon','delmon','quanly_lop','addlop','dellop','quanly_dsgv','addgv','delgv','addhs','delhs', 'import','importgv','quanly_diem','adddiem','deldiem','quanly_xl','addxl','delxl', 'config', 'khoitaodl','khoitaoxl','change_ac','quanly_tkb','edit_tkb','quanly_lichthi','ltcontent', 'user');
}elseif(defined('NV_IS_SPADMIN')){
	$allow_func = array( 'main',  'quanly', 'quanly_nam', 'test', 'addnam','delnam','quanly_mon', 'addmon','delmon','quanly_lop','addlop','dellop','quanly_dsgv','addgv','delgv','addhs','delhs', 'import','importgv','quanly_diem','adddiem','deldiem','quanly_xl','addxl','delxl', 'khoitaodl','khoitaoxl','change_ac','quanly_tkb','edit_tkb','quanly_lichthi','ltcontent','user');
}else{
	$allow_func = array( 'main', 'quanly', 'quanly_nam', 'test', 'addnam','delnam','quanly_mon', 'addmon','delmon','quanly_lop','addlop','dellop','quanly_dsgv','addgv','delgv','addhs','delhs','quanly_diem','adddiem','deldiem','quanly_xl','addxl','delxl', 'khoitaodl','khoitaoxl','change_ac','quanly_tkb','edit_tkb','quanly_lichthi','ltcontent','user');
